...
const AddToCartButton = dynamic(() => import('../shopping-interactivity/AddToCartButton'))
const ProductWishlistToggler = dynamic(() => import('../shopping-interactivity/ProductWishlistToggler'))
